from flask import make_response, render_template, redirect, url_for, flash, request, current_app, abort
from . import main
...
def followers(username):
    ...
    return render_template('followers.html', user=user, title='На кого подписан',
